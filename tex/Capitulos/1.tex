...
\item \begin{equation}
\sum_{i=1}^{n} \sum_{j=1}^m w_{j,k} \cdot x_{i,j} \leq N_k \footnote{$M_j$ es la cota superior de la universidad $j$, $m_j$ es la cota inferior de la universidad $j$ y $N_j$ es la cota superior de la restricción $k$.} %z_k
\end{equation} 
