...
Para los capitulos 1, 3 y 4 usamos como referencia principal \cite{GaleShapley}, para el capítulo 5 \cite{empates}, para el capitulo 9 \cite{matroid} y para los capitulos 6, 7 , 8 y 10 \cite{Todo}.
