...
\title{El problema de admisión a universidades con cotas inferiores y comunes} %Con este nombre se guardará el proyecto en writeLaTex
...
% A Esther, por obligarme a acabar este trabajo
...
Para los capítulos 1, 3 y 4 usamos como referencia principal \cite{GaleShapley}; para el capítulo 5 \cite{empates}; para el capítulo 9 \cite{matroid} y para los capítulos 6, 7 , 8 y 10 \cite{Todo}. 
